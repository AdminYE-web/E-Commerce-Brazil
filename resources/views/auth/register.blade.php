                ...
                <form method="POST" action="{{ route('register.submit') }}">
                    ...
                    <div class="register-row">
                        <div class="register-group">
                            ...
                            <input type="text" name="first_name" class="register-input"
                                placeholder="{{ __('messages.auth.first_name') }}" value="{{ old('first_name') }}" required>
                        </div>

                        <div class="register-group">
                            <label class="register-label">{{ __('messages.auth.last_name') }} <span>*</span></label>
                            <input type="text" name="last_name" class="register-input"
                                placeholder="{{ __('messages.auth.last_name') }}" value="{{ old('last_name') }}" required>
                        </div>
                    </div>
                    <div class="register-group">
                        <label class="register-label">
                           {{ __('messages.auth.phone') }} <span>*</span>
                        </label>

                        <input type="text" name="phone" class="register-input" placeholder="{{ __('messages.auth.phone_placeholder') }}"
                    ...
                    <div class="register-group">
                        ...
                        <input type="email" name="email" class="register-input"
                            placeholder="{{ __('messages.auth.email_placeholder') }}" value="{{ old('email') }}"
                            required>
                    </div>
                    ...
                    <div class="register-group">
                        ...
                        <input type="password" name="password_confirmation" class="register-input"
                            placeholder="{{ __('messages.auth.confirm_password') }}" required>
                    </div>
