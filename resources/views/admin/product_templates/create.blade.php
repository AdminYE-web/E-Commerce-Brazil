        ...
        <div class="table-card template-page-card">
            <div class="table-header">
                <div>
                    <div class="table-title">
                        {{ request()->cookie('dev') === '1' ? 'Create Product Template' : '製品テンプレートの作成' }}
                    </div>
                    <div class="showing-text">
                        {{ request()->cookie('dev') === '1' ? 'Upload PDF / AI template.' : 'PDF / AIテンプレートのアップロード' }}
                        Current language: {{ strtoupper($language) }}</div>
                </div>
            ...
            <div class="template-actions">
                <button type="submit" class="template-save-btn">
                    {{ request()->cookie('dev') === '1' ? 'Save Template' : 'テンプレートを保存' }}
                </button>
