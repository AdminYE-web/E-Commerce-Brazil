...
<form action="{{ route('admin.product-templates.update', $template->template_id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="table-card template-page-card">
        <div class="table-header">
            <div>
                <div class="table-title">Edit Product Template</div>
