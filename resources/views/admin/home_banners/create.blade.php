...
<div class="form-card">
    <div class="form-header">
        <div>
            ...
            <p>Create homepage banner for PC and mobile, link, sorting and status.</p>
        </div>
    ...
    <form action="{{ route('admin.home-banners.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="link_url" value="{{ old('link_url') }}" placeholder="https://example.com หรือ /products">
            </div>
