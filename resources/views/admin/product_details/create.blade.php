...
@section('title', 'Add Product Detail | Indigo Admin')
        ...
        wrapper.insertAdjacentHTML('beforeend', `
            <div class="dynamic-item detail-item">
                ...
                <div class="form-grid">
                    <div class="form-group full">
                        <label>Headline</label>
                        <input type="text" name="detail_content[${detailIndex}][headline]">
                    </div>
        ...
        wrapper.insertAdjacentHTML('beforeend', `
            <div class="dynamic-item spec-item">
                <div class="dynamic-item-header">
                    ...
                    <button type="button" class="btn-danger-light remove-spec-item">Remove</button>
                </div>

                <div class="form-grid">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" name="specification_content[${specIndex}][title]" placeholder="เช่น Width Options:">
                    </div>
        ...
        wrapper.insertAdjacentHTML('beforeend', `
            <div class="dynamic-item accordion-item-admin">
                ...
                <div class="form-grid">
                    <div class="form-group full">
                        <label>Title</label>
                        <input type="text" name="accordion_content[${accordionIndex}][title]" placeholder="เช่น Production fee">
                    </div>
