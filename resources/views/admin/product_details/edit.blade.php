...
<form action="{{ route('admin.product-details.update', $detail->product_detail_id) }}" method="POST" enctype="multipart/form-data">
    ...
    @if($detail->specification_image)
        <img 
            src="{{ asset('storage/' . $detail->specification_image) }}" 
            width="180"
                ...
                <div class="detail-item" style="border:1px solid #ddd; padding:15px; margin-bottom:15px;">
                    ...
                    <div>
                        ...
                        @if(!empty($item['icon_image']))
                            <img 
                                src="{{ asset('storage/' . $item['icon_image']) }}" 
                                width="50"
                        ...
                        <input 
                            type="hidden" 
                            name="detail_content[{{ $index }}][icon_image]" 
...
<div>
    ...
    <div id="spec-content-wrapper">
        @php
            $oldSpecs = old('specification_content', $detail->specification_content ?? [
                [
                    'title' => '',
                    'desc' => '',
                    'icon_image' => '',
...
<div>
    ...
    <input 
        type="text" 
        name="specification_content[{{ $index }}][link_text]" 
...
<div>
    ...
    <input 
        type="text" 
        name="specification_content[{{ $index }}][link_url]" 
        value="{{ $item['link_url'] ?? '' }}"
        style="width:100%;"
...
<div>
    ...
    <div id="accordion-content-wrapper">
        @php
            $oldAccordions = old('accordion_content', $detail->accordion_content ?? [
                [
                    'title' => '',
                    'content' => '',
                ]
