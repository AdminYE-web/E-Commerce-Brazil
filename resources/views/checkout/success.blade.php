...
@php
    ...
    $confirmationEmail = $customer->personal_email
...
<div class="order-success-page">
    <div class="order-success-wrap">
        ...
        <p class="success-desc">
            Obrigado por sua compra! Seu pedido foi recebido com sucesso e já estamos
        ...
        <div class="order-info-box">
            ...
            <div class="order-info-item">
                <div class="order-info-label">Status do Pagamento</div>
            ...
            <div class="order-info-item">
                <div class="order-info-label">E-mail de Confirmação</div>
                <div class="order-info-value">
                    {{ $confirmationEmail }}
                </div>
            </div>
