...
<body>
    ...
    <div class="receipt-header">
        ...
        <div class="receipt-subtitle">Order receipt / payment summary</div>
    </div>
    ...
    <table class="items-table">
        ...
        <tbody>
            @foreach($order->items as $item)
                ...
                <tr>
                    <td>
                        <strong>{{ $item->product_name_snapshot ?? $item->product_name }}</strong><br>
                        <span>Sub-Order Number: {{ $item->sub_order_no ?? '-' }}</span>
    ...
    <table class="summary-table">
        ...
        <tr class="grand-total">
            <td>Grand Total</td>
            <td class="text-right">¥{{ number_format($order->grand_total ?? 0, 2) }}</td>
        </tr>
    </table>
