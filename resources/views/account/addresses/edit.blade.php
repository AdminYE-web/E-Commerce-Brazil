    ...
    <div class="container">
        <div class="account-layout">
            ...
            <main class="address-card">
                <h1>Edit {{ ucfirst($type) }} Address Information</h1>
                <div class="address-divider"></div>

                <form action="{{ route('account.addresses.update', $address->user_address_id) }}" method="POST" class="address-form">
                    @csrf
                    @method('PUT')

                    <div class="address-group full">
                        <label>Label <span>*</span></label>
                        <input type="text" name="label" value="{{ old('label', $address->label) }}" placeholder="Label">
                    ...
                    <div class="address-form-grid">
                        <div class="address-group">
                            ...
                            <input type="text" name="first_name" value="{{ old('first_name', $address->first_name) }}" placeholder="First Name">
                            @error('first_name') <div class="error-text">{{ $message }}</div> @enderror
                        </div>

                        <div class="address-group">
                            <label>Last Name<span>*</span></label>
                            <input type="text" name="last_name" value="{{ old('last_name', $address->last_name) }}" placeholder="Last Name">
                    ...
                    <div class="address-group full">
                        ...
                        <input type="text" name="phone" value="{{ old('phone', $address->phone) }}" placeholder="Phone number">
                        @error('phone') <div class="error-text">{{ $message }}</div> @enderror
                    </div>

                    <div class="address-group full">
                        <label>Company Name (optional)</label>
                        <input type="text" name="company_name" value="{{ old('company_name', $address->company_name) }}" placeholder="Company Name">
                        @error('company_name') <div class="error-text">{{ $message }}</div> @enderror
                    </div>

                    <div class="address-group full">
                        <label>Address<span>*</span></label>
                        <input type="text" name="address" value="{{ old('address', $address->address) }}" placeholder="Street address">
                        @error('address') <div class="error-text">{{ $message }}</div> @enderror
                    </div>

                    <div class="address-group full">
                        <label>Apartment, suite, etc. (optional)</label>
                        <input type="text" name="apartment" value="{{ old('apartment', $address->apartment) }}" placeholder="Apartment, suite, unit, etc.">
                    ...
                    <div class="address-group full">
                        ...
                        <select name="country">
                            ...
                            <option value="Japan" {{ old('country', $address->country) === 'Japan' ? 'selected' : '' }}>Japan</option>
                    ...
                    <div class="address-3-col">
                        <div class="address-group">
                            ...
                            <input type="text" name="city" id="city" value="{{ old('city', $address->city) }}" placeholder="City">
                        ...
                        <div class="address-group">
                            ...
                            @error('zip_code') <div class="error-text">{{ $message }}</div> @enderror
                        </div>
                    </div>

                    <label class="address-checkbox">
                        <input type="checkbox" name="is_main" value="1" {{ old('is_main', $address->is_main) ? 'checked' : '' }}>
